...
export default function CoworkToolCard({
  ...
  const getConfigStatus = () => {
    ...
    return status.hasZenConsole ? "configured" : "other";
  };
          ...
          {!checking && status?.installed && (
            <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <Button variant="outline" size="sm" onClick={handleReset} disabled={!status.hasZenConsole} loading={restoring} className="w-full sm:w-auto">
